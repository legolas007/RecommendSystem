...
public class HDFSFile {
	...
	public static void main (String arg[]) throws Exception{
		//
		HDFSFile file = new HDFSFile(new Path("hdfs://192.168.32.130:9000/test/"));
		Path dst = new Path("hdfs://192.168.32.130:9000/test/");
		Path src = new Path("/home/usher/hello.txt");
		//创建目录
		//file.mkDir(dst);
		//上传本地文件到Hdfs
